...
def eval_model(model, loader, device, out_csv):
    ...
    with torch.no_grad():
        for i, (imgs, labels) in enumerate(loader):
            ...
            all_r_0A.append(out["r_0A"].cpu().numpy())
...
def main():
    ...
    ap.add_argument("--out_val_csv", type=str, default="roi_val_boundary.csv")
    ap.add_argument("--out_test_csv", type=str, default="roi_test_boundary.csv")
